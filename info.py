...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001541833234 -1001642374850 -1002377622184').split()]  # For Multiple Id Use One Space Between Each.
